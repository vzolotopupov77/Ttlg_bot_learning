...
## Уточнение статусов (после закрытия итерации 7)

- **Итерация 3** в [README.md](../../../../../README.md) и [plan.md](../../../../plan.md) отражена как **🚧 In Progress — частично**: backend+бот закрывают MVP (тонкий клиент, диалог, базовый контекст), полный DoD итерации 3 по продукту — ещё нет.
